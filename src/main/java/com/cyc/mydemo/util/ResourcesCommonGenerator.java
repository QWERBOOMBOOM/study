...
public class ResourcesCommonGenerator {
    ...
    public static void generator(Map<String,String> map,String[] excludedTable){
        ...
        String entityOutputDir = map.get("entityDir") +"/";
        String serviceOutputDir = map.get("serviceDir")+"/";
        String serviceImplOutputDir = map.get("serviceDir")+"/impl/";
        String controllerOutputDir = map.get("controllerDir")+"/";
        String mapperOutputDir = map.get("mapperDir")+ "/";
        String enumOutputDir = map.get("entityDir") + packageDir+ "enums/";
        ...
        dsc.setTypeConvert(new MySqlTypeConvert(){
            ...
            public IColumnType processTypeConvert(GlobalConfig globalConfig, String fieldType) {
                ...
                if(type.contains("datetime") || type.contains("date")){
                    return BPDbColumnType.DATE;
                }else if(type.contains("blob") || type.contains("text")){
                    return BPDbColumnType.STRING;
                }else {
        ...
        focList.add(new FileOutConfig("/templates/service.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return serviceOutputDir + tableInfo.getEntityName() + "Service.java";
            }
        });
        focList.add(new FileOutConfig("/templates/serviceImpl.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return serviceImplOutputDir + tableInfo.getEntityName() + "ServiceImpl.java";
            }
        });
        focList.add(new FileOutConfig("/templates/controller.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return  controllerOutputDir+ tableInfo.getEntityName() + "Controller.java";
            }
        });
...
/*        focList.add(new FileOutConfig("/templates/enum.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                for(TableField tableField : fieldList){
                    if (tableField.getType().equals("tinyint(2)")) {
                        enumExist = true;
                    }
                }
                if(enumExist){
